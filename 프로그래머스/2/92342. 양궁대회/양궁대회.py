def solution(n, info_A):
    ...
    rate = [[10-i,(2-(hit==1))*(10-i),hit] for i,hit in enumerate(arrow_L)]
    ...
    for i in dp[n][1]:info_L[10-i] = arrow_L[10-i]
    info_L[-1] = n-sum(info_L)        
    answer = sum(((l>a)-(a>l))*(10-i) for i,(a,l) in enumerate(zip(info_A,info_L)))
